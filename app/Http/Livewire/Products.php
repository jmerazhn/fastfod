...
class Products extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.products.component', ['products' => $info, 'categories' => Category::orderBy('name', 'asc')->get()])
    ...
    public function resetUI()
    {
        ...
        $this->resetPage();
        $this->reset('name', 'code', 'cost', 'price', 'price2', 'stock', 'minstock', 'selected_id', 'search', 'action', 'componentName', 'gallery');
    }
