                ...
                <div class="mt-4">
                    <div class="sm:grid grid-cols-3 gap-5">
                        ...
                        <div>
                            ...
                            <input wire:model="city" id="city" type="text" class="form-control form-control-lg border-start-0 kioskboard {{($errors->first('city') ? "border-danger" : "")}}" placeholder="eje: México" maxlength="35" />
                            @error('city')
                            <x-alert msg="{{ $message }}" />
                            @enderror
                        </div>
